...
job_flow_overrides = {
    ...
    "LogUri": "s3://redfin-data-emr/emr-logs/",
...
SPARK_STEPS_EXTRACTION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                "s3://redfin-data-emr/scripts/ingest.sh",
            ],
        },
    },
   ]
...
SPARK_STEPS_TRANSFORMATION = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": ["spark-submit",
            "s3://redfin-data-emr/scripts/transform_redfin_data.py",
            ],
        },
    },
   ]
