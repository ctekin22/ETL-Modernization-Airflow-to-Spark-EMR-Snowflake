...
# s3 buckets - raw target
target_bucket_name = 'redfin-raw-data-bucket-airflow' 
...
def extract_data(**kwargs):
    ...
    # It takes in task_instance, which is a special parameter passed automatically by Airflow when running a PythonOperator.
    # The task_instance is used to pull data from XComs, which are Airflow’s way of sharing data between tasks.
...
with DAG('redfin_analytics_dag',
        ...
        load_to_s3 = BashOperator(
            ...
            bash_command = 'aws s3 mv {{ ti.xcom_pull("tsk_extract_redfin_data")[0]}} s3://redfin-transformed-data-bucket-airflow',
        )
